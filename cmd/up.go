...
func init() {
	...
	upCmd.Flags().String("svcgrp", "", "Defines a failure domain boundary for anomaly correlation. Learn more: https://docs.sciencelogic.com/zebrium/latest/Content/Web_Zebrium/Key_Concepts.html#service-groups")
